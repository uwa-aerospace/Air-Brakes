...
float PIDController(float desiredHeight, DATA_POINT *currentData)
{
    ...
    float requiredDeceleration = ((currentData->vertical_speed * currentData->vertical_speed) / (2 * (desiredHeight - currentHeight))) - 9.81 + currentData->vertical_acceleration;
    ...
    {
        // float returnValue = ((currentData->vertical_speed * currentData->vertical_speed) / (2 * (result))) - 9.81 + currentData->vertical_acceleration;
